...
<div class="box-container">
    <h2 class="h2 text-center">＜タイヤパンク保証サービス　保証書＞</h2>
    <div class="box-border-1">
        <div>【サービス概要】</div>
        <div>宇佐美グループ各販売店で購入されたタイヤが本保証書記載のサービス期間中に所定の損害を被った場合、下記の「宇佐美タイヤパンク保証サービス約款」に基づき、所定の金額を限度に、宇佐美各販売店にてタイヤの修理・交換をいただくことができます。</div>
    ...
    <div class="clearfix">
        <div class="box-part-2">
            ...
            <div class="color-red font-bold">※乗用車用タイヤに限る。</div>
            <div>【サービス内容】</div>
            ...
            <div>【サービスの提供場所】</div>
            <div>第６条 サービスの提供を受ける場合には、お客様が宇佐美グループ各販売店へ対象タイヤをお持ちいただき、保証書および作業伝票をご提示の上、お申し付けください。 宇佐美グループ各販売店以外でタイヤを購入・修理・交換された場合、本サービスはご利用いただけません。尚、<span class="color-red font-bold">タイヤの修理・交換の作業対象時間は8:00～18:00</span>（※一部店舗においては作業対象時間が異なる場合があります）とさせていただきます。
            </div>
        ...
        <div class="box-part-2">
            <div class="box-color-red font-bold">
                ...
                ⑤戦争・外国の武力行使・革命・政権奪取・内乱・武装反乱・その他の類似の事変　または暴動（群衆または多数の者の集団行動によって全国または一部の地区において著しく平穏が害され、治安維持上重大な事態と認められる状態をいいます）<br />
                ⑥差押え、収用、没収、破壊など国または公共団体の公権力の行使<br />
                ⑦詐欺または横領<br />
                ⑧対象タイヤを装着した自動車の不適切な保管、仕様の限度を超える過酷な仕様（レース、ラリー等による過酷な走行）による事故<br />
                ⑨違法改造車両による事故<br />
