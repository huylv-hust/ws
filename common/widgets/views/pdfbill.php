...
<div class="box-container">
    ...
    <h2 class="h2">＜タイヤパンク保証サービス　約款＞</h2>
    <div>
    ...
    <div class="clearfix">
        <div class="box-part-2">
            ...
            <div>【サービスの提供場所】</div>
            <div>第６条 サービスの提供を受ける場合には、お客様が宇佐美グループ各販売店へ対象タイヤをお持ちいただき、保証書および作業伝票をご提示の上、お申し付けください。宇佐美グループ各販売店以外でタイヤを購入・修理・交換された場合、本サービスはご利用いただけません。尚、<span class="color-red">タイヤの修
        ...
        <div class="box-part-2">
            <div class="box-color-red">
                ...
                ⑤戦争・外国の武力行使・革命・政権奪取・内乱・武装反乱・その他の類似の事変または暴動（群衆または多数の者の集団行動によって全国または一部の地区において著しく平穏が害され、治安維持上重大な事態と認められる状態をいいます）<br />
