...
class confirm
{
    public static function writeconfirm($post = array())
    {
        ...
        $data[1] = array(
            'tire_1' => isset($post['tire_1']) ? 1 : 0,
            'tire_2' => isset($post['tire_2']) ? 1 : 0,
            'tire_3' => isset($post['tire_3']) ? 1 : 0,
            'tire_4' => isset($post['tire_4']) ? 1 : 0,
            'pressure_front' => isset($post['pressure_front']) ? 1 :0,
            'pressure_behind' => isset($post['pressure_behind']) ? 1 : 0,
            'rim' => isset($post['rim']) ? 1 : 0 ,
            'torque' => isset($post['torque']) ? 1 : 0 ,
            'foil' => isset($post['foil']) ? 1 : 0,
            'nut' => isset($post['nut']) ? 1 : 0,
            'oil' => isset($post['oil']) ? 1 : 0,
            'oil_cap' => isset($post['oil_cap']) ? 1 : 0,
            'level' => isset($post['level']) ? 1 : 0,
            'drain_bolt' => isset($post['drain_bolt']) ? 1 : 0,
            'packing' => isset($post['packing']) ? 1 : 0,
            'oil_leak' => isset($post['oil_leak']) ? 1 : 0,
