...
class csv
{
    public static function writecsv($post = array())
    {
        ...
        $data[1] = array(
            ...
            'right_front_no' => isset($post['right_front_no']) ? $post['right_front_no'] : '',
            ...
            'left_front_no' => isset($post['left_front_no']) ? $post['left_front_no'] : '',
            ...
            'right_behind_no' => isset($post['right_behind_no']) ? $post['right_behind_no'] : '',
            ...
            'left_behind_no' => isset($post['left_behind_no']) ? $post['left_behind_no'] : '',
            ...
            'other_a_no' => isset($post['other_a_no']) ? $post['other_a_no'] : '',
            ...
            'other_b_no' => isset($post['other_b_no']) ? $post['other_b_no'] : '',
