...
<footer id="footer">
	<div class="toolbar"><a href="<?php echo \yii\helpers\BaseUrl::base(true) ?>/menu.html" class="btnBack">メニュー</a>
		<div class="btnSet">
			<a href="<?php echo \yii\helpers\BaseUrl::base(true) ?>/list-workslip.html" class="btnTool">情報検索</a>
			<a href="<?php echo \yii\helpers\BaseUrl::base(true) ?>/preview.html" class="btnTool"
			   target="_blank">作業確認</a>
