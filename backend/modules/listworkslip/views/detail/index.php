            ...
            <fieldset class="fieldsetRegist">
                ...
                <div class="formGroup">
                    ...
                    <div class="formItem">
                        ...
                        <p class="txtValue"><?php echo $detail['D03_JIKAI_SHAKEN_YM']; ?></p>
                    </div>
                    <div class="formItem">
            ...
            <fieldset class="fieldsetRegist">
                ...
                <div class="formGroup">
                    <div class="formItem">
                        ...
                        <p class="txtValue"><?php echo Yii::$app->formatter->asDate($detail['D03_SEKOU_YMD'], 'yyyy/MM/dd'); ?></p>
                    </div>
                    <div class="formItem">
                ...
                <table class="tablePrint bgWhite">
                    ...
                    <tr>
                        <td colspan="2"><p class="leftside">タイヤ交換図</p>
                            <div class="areaPrintCheckImg"><img src="<?php  echo \yii\helpers\BaseUrl::base(true)?>/img/handwriting.png" alt="" class="itemPrintCheckImg">
                        ...
                        <td colspan="2"><p class="leftside">空気圧</p>
                            <div class="areaAirCheck">
                                <div class="itemPrintAir">
                                    <p class="txtValue"><span class="txtUnit">前</span><span class="spcValue"><input type="number" class="textFormConf" value="1000" disabled=""></span><span class="txtUnit">kpa</span></p>
                                </div>
                                <div class="itemPrintAir">
                                    <p class="txtValue"><span class="txtUnit">後</span><span class="spcValue"><input type="number" class="textFormConf" value="1000" disabled=""></span><span class="txtUnit">kpa</span></p>
                                </div>
                            </div></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2"><p class="leftside">次回交換目安</p>
                            <div class="checkPrint">
                                <p class="txtValue"><input type="number" class="textFormConf" value="2016" disabled="" maxlength="4" style="width:4em;"><span class="txtUnit">年</span><input type="number" class="textFormConf" value="12" disabled="" maxlength="2" style="width:2em;"><span class="txtUnit">月</span><input type="number" class="textFormConf" value="31" disabled="" maxlength="2" style="width:2em;"><span class="txtUnit">日　または、</span><input type="number" class="textFormConf" value="100" disabled=""><span class="txtUnit">km</span></p>
                            </div></td>
                    </tr>
                    <tr>
            ...
            <fieldset class="fieldsetRegist">
                ...
                <div class="formGroup lineTop">
                    <div class="flexRight">
                        ...
                        <p class="txtValue"><strong class="totalPrice"><?php echo $detail['D03_SUM_KINGAKU']; ?></strong><span class="txtUnit">円</span></p>
                    </div>
                </div>
            </fieldset>
        </section>
...
<footer id="footer">
    <div class="toolbar"><a href="<?php echo \yii\helpers\BaseUrl::base(true)?>/menu.html" class="btnBack">メニュー</a>
        ...
        <?php if(!empty($detail['sagyo']) || !empty($detail['D03_TANTO_SEI'] || !empty($detail['D03_KAKUNIN_SEI']))){
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form method="post" action="<?php echo \yii\helpers\BaseUrl::base(true)?>/listworkslip/detail/status">
                    <input type="hidden" name="den_no" value="<?php echo $detail['D03_DEN_NO'];?>">
                    <button type="submit" class="btnSubmit flRight">はい</button> </div>
                </form>
        </div>
    </div>
</div>
